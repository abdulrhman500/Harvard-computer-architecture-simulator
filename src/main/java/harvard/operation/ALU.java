...
public class ALU {
    ...
    public void RegisterInstruction(Instuctions instruction , String firstRegister, String secondRegister) throws InvalidInstructionException {
        ...
        case ADD:{
            ...
            ((SREG)RegisterFile.getInstance().getRegister("SREG")).setVBit((R1.getData() > 0 && R2.getData()>0 && bytetmp<0)||
        ...
        case SUB:{
            ...
            ((SREG)RegisterFile.getInstance().getRegister("SREG")).setVBit((R1.getData() > 0 && R2.getData()<0 && tmp<0)||
    ...
    public void ImmediateInstruction(Instuctions instruction , String register ,byte imm) throws InvalidInstructionException, IncorrectMemoryAddressException {
        RegisterFile registerFile = RegisterFile.getInstance();
