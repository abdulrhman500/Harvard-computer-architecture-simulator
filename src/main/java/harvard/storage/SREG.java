...
public class SREG extends Register {
    ...
    public void updateFlags(EInstuctions Einstruction, int result, Byte register1, Byte register2) throws HarvardComputerArchException {

        switch (Einstruction){
            case ADD: boolean carry = ((result >> 8) & 1) == 1;
